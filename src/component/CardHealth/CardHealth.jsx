...
export default function CardHealth() {
    ...
    const { sliderData, status, error } = useSelector((state) => state.sliderData);
    useEffect(() => {
    ...
    useEffect(() => {
        if (sliderData) {
            ...
            setIconStyleChange(new Array(sliderData.length).fill("regular"));
        }
    }, [sliderData]);
    ...
    const handleViewMore = () => {
        if (showAll) {
            ...
            setVisibleCount(sliderData.length);
        }
        setShowAll(!showAll);
    };
    ...
    return (
        <React.Fragment>
            <div className="main-card">
                <div className="row">
                    {sliderData?.slice(0, visibleCount).map((article, index) => (
                            ...
                            <div className="wrapper-card">
                                ...
                                <div className="all-icon-main">
                                    ...
                                    >
                                        <FontAwesomeIcon
                                            icon={
                                                iconStyle[index] === "regular"
                                                    ? faHeartRegular
                                                    : faHeartSolid
                                            }
                                            className={`icon ${
                                                iconStyle[index] === "solid"
                                                    ? "clicked"
                                                    : ""
                                            }`}
                                        />
                ...
                <div className="text-center  main-btn">
                    <button className="btn-main-view" onClick={handleViewMore}>
