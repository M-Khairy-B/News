...
export default function RelatedTopics() {
    ...
    // console.log(sliderData?.slice(0, 5));
    useEffect(() => {
        if (sliderData) {
    ...
    return (
        <React.Fragment>
            <section className="relatedtopics">
                ...
                <div className="container">
                    <div className="row">
                        {sliderData?.slice(20, 25).map((dataMain , index)=>(
                                <div className="col-main" key={index}>
                                <div className="wrapper-related">
                                    <div className="image-related">
                                        <Link>
                                        <img
                                            className="w-100"
                                            src={dataMain?.urlToImage}
                                            alt=""
                                            onClick={() => handleNavigate(dataMain)}
                                    ...
                                    <div className="image-title">
                                        <h3>{dataMain?.title}</h3>
                                    </div>
                                    <div className="heart-share-bookmark">
                                        <Link
                                            className="link-item"
                                        ...
                                        >
                                            <FontAwesomeIcon
                                                icon={
                                                    iconStyleChange[index] === "regular"
                                                        ? faBookmarkRegular
                                                        : faBookmartSolid
                                                }
                                                className={`icon ${
                                                    iconStyleChange[index] === "solid"
                                                        ? "main"
                                                        : ""
                                                }`}
                                            />
